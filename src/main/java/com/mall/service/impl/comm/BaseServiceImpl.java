...
public class BaseServiceImpl {
    @Autowired
    private TAdsCategoryMapper tAdsCategoryMapper;
    @Autowired
    ...
    public TAdsCategoryMapper gettAdsCategoryMapper() {
        return tAdsCategoryMapper;
    }
    /** 
     * @param tAdsCategoryMapper 要设置的 tAdsCategoryMapper 
     */
    
    public void settAdsCategoryMapper(TAdsCategoryMapper tAdsCategoryMapper) {
        this.tAdsCategoryMapper = tAdsCategoryMapper;
    }
    /** 
